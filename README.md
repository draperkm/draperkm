...
* [`Retrival Augmented Generation (RAG)`]([https://full-trading-app.onrender.com/](https://github.com/draperkm/rag_chat_with_websites)) : web application created with Python, Langchain, Pinecone and Streamlit
